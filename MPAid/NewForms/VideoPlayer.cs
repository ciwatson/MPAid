...
namespace MPAid.NewForms
{
    public partial class VideoPlayer : Form
    {
        ...
        {
            foreach (Word wd in soundListAllListBox.SelectedItems)
            {
                if (!soundListCurrentListBox.Items.Contains(wd))
                {
                    soundListCurrentListBox.Items.Insert(0, wd);    // Insert at index 0 so the user is more likely to see it.
                }
            }
        }
    }
