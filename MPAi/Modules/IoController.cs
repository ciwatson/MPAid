...
namespace MPAi
{
    ...
    public static class IoController
    {
        ...
        /// <summary>
        /// Gets the current MPAi directory.
        /// </summary>
        /// <returns>The current MPAi directory, as a string.</returns>
        public static string GetAppDataDir()
        {
            if (!Directory.Exists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\MPAi"))
            {
                Directory.CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\MPAi");
            }
            return Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\MPAi";
        }

        /// <summary>
        /// Gets the input user's directory in the MPAi directory.
        /// </summary>
